...
function jsonSerialize($variavel) {
    return json_encode(toArray($variavel));
}
        ...
        foreach ($array as $key => $var) {
            ...
            foreach ($properties as $property) {
                ...
                if ($property->name != 'primarykey') {
                    ...
                    if (method_exists($var, $function)) {
                        $value = $var->$function(); // Obtem o valor da propriedade
                    } else {
                        $value = null;
                    }
                    ...
                    if (is_object($value)) {
                        ...
                        $arrProperties[$key][$property->name] = $value->toArray();
                    } else {
                        $arrProperties[$key][$property->name] = $value;
                    }
                }
            }
        }
